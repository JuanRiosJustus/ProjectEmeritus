...
//    public static final int APPLICATION_HEIGHT = 1080;
    ...
    public static final String WALLS_SPRITESHEET_FILEPATHv1 = file("./res/graphics/walls.png");
    public static final String FLOORS_SPRITESHEET_FILEPATHv1 = file("./res/graphics/floors.png");
    ...
    public static final String STRUCTURES_SPRITESHEET_FILEPATH = file("./res/tiles/structures/");
    public static final String FLOORS_SPRITESHEET_FILEPATH = file("./res/tiles/floors/");
    public static final String WALLS_SPRITESHEET_FILEPATH = file("./res/tiles/walls/");
    public static final String LIQUIDS_SPRITESHEET_FILEPATH = file("./res/tiles/liquids");
