...
public class GameStateKey {
    public static final String CURRENTLY_SELECTED = "currently.selected.from.user";
    public static final String PREVIOUSLY_SELECTED = "previously.selected.from.user";
