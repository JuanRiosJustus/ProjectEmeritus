...
//    public final EndTurnPanel actions;
//    public final SelectionPanel selection;
//
//    public MovementPanel movement = new MovementPanel(444,44, "434");
//    public LogPanel log = new LogPanel();
//    public AbilityPanel ability = new AbilityPanel();
//    public ConditionPanel summary = new ConditionPanel(444,44);
...
//        add(selection);
//
//        actions = new EndTurnPanel(Constants.SIDE_BAR_WIDTH, (int) (Constants.APPLICATION_HEIGHT * .15));
//        add(actions);
//
...
//        model.state.set(Constants.ABILITY_UI_SHOWING, ability.isShowing());
//        model.state.set(Constants.SETTINGS_UI_SHOWING, settings.isShowing());
