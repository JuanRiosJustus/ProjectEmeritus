...
public class GameEditorPanelItem extends JPanel {
...
//    private JToggleButton m_selectedButton = new JToggleButton("Select");
    ...
    public GameEditorPanelItem(BufferedImage image, int index) {
        panelImage = image;
        panelIndex = index;
...
//        topBot.add(new JRadioButton(), BorderLayout.EAST);
    ...
    public String getLayerType() { return Objects.requireNonNull(label.getText()).toString(); }
