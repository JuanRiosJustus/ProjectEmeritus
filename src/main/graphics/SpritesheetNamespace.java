...
public class SpritesheetNamespace {
    private final Map<String, Spritesheet> mSpriteSheetMap = new LinkedHashMap<>();
    private final static EmeritusLogger logger = EmeritusLogger.create(SpritesheetNamespace.class);

    public SpritesheetNamespace(String path, int spriteWidths, int spriteHeights) {
