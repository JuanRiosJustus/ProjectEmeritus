...
public class RenderContext {
    ...
    private Entity mHoveredTile = null;
...
//        }
        ...
        String hoveredTileID = model.getHoveredTileID();
        Entity entity = EntityStore.getInstance().get(hoveredTileID);
        context.mHoveredTile = entity;
    ...
    public Entity getHoveredTile() { return mHoveredTile; }
