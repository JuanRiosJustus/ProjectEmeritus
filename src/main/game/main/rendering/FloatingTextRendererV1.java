...
public class FloatingTextRendererV1 extends RendererV1 {
    ...
    public void render(Graphics graphics, GameModel model, RenderContext context) {
        ...
        Font generalFont = FontPoolV1.getInstance().getFont(generalFontSize);
        ...
        context.getFloatingText().forEach(ft -> {
            ...
            Font fontToUse = FontPoolV1.getInstance().getFont(fontSize);
            ...
            mRendererUtilsV1.renderTextWithOutline(g2d, x, y, ft.getText(), fontSize, ft.getForeground(), ft.getBackground());
        });
    }
}