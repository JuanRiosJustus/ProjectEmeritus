...
public class MainControlsPanelV2 extends GameUI {
    ...
    public MainControlsPanelV2(int x, int y, int width, int height, Color color) {
        this(x, y, width, height, color, 4);
    }

    public MainControlsPanelV2(int x, int y, int width, int height, Color color, int visibleRows) {
        super(width, height);
