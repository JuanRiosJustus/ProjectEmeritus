...
//    public AnimationSystem() { }
    ...
    public static JSONObject createAnimationEvent(
            String unitID,
            String animation,
            List<String> tileIDs,
            String unitWithAnimationToWaitOnID
    ) {
...
//        componentToApplyAnimationTo.addOnCompleteListener(() -> {
//            String lastTileEntityID = tileIDs.getString(0);
//            Entity lastTileEntity = getEntityWithID(lastTileEntityID);
//            Tile tile = lastTileEntity.get(Tile.class);
//            tile.setUnit(lastTileEntityID);
//        });
    }
