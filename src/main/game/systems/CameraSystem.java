...
public class CameraSystem extends GameSystem {
    ...
    private void setCamera(String camera, int x, int y) {
...
//        gameState.setCameraX(camera, x);
//        gameState.setCameraY(camera, y);
        ...
        int adjustedX = (int) (x- viewportWidth / 2);
        int adjustedY = (int) (y - viewportHeight / 2);
        ...
        gameState.setCameraX(camera, finalDestinationX);
        gameState.setCameraY(camera, finalDestinationY);
    }
