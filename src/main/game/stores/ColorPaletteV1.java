...
public class ColorPaletteV1 {

    private static ColorPaletteV1 mInstance = null;
    public static ColorPaletteV1 getInstance() {
        if (mInstance == null) {
            mInstance = new ColorPaletteV1();
        }
        return mInstance;
    }

    private static final EmeritusLogger logger = EmeritusLogger.create(ColorPaletteV1.class);
    private final Map<String, Color> mColorMap = new HashMap<>();

    private ColorPaletteV1() {
