...
public class AssetPoolV1 {
    ...
    private static final EmeritusLogger logger = EmeritusLogger.create(AssetPoolV1.class);
    ...
    private static AssetPoolV1 instance = null;
    public static AssetPoolV1 getInstance() {
        if (instance == null) {
            instance = new AssetPoolV1();
        }
        return instance;
    }
