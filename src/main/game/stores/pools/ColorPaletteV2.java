...
public class ColorPaletteV2 {
    ...
    private static ColorPaletteV2 mInstance = null;
    public static ColorPaletteV2 getInstance() {
        if (mInstance == null) {
            mInstance = new ColorPaletteV2();
        }
        return mInstance;
    }

    private static final EmeritusLogger logger = EmeritusLogger.create(ColorPaletteV2.class);
    private final Map<String, Color> mColorMap = new HashMap<>();

    private ColorPaletteV2() {
