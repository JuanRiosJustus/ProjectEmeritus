...
public class ColorPalette {
    ...
    public static final Color BLACK_LEVEL_1 = Color.rgb(0, 0, 0,.25);
    public static final Color BLACK_LEVEL_2 = Color.rgb(0, 0, 0,.5);
    public static final Color BLACK_LEVEL_3 = Color.rgb(0, 0, 0,.75);
    public static final Color BLACK_LEVEL_4 = Color.rgb(0, 0, 0,1);
