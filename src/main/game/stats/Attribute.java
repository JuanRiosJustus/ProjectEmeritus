...
public class Attribute {
    ...
    public void putAdditiveModification(String source, String name, float value) { putModification(source, name, ADDITIVE, value); }
    public void putMultiplicativeModification(String source, String name, float value) { putModification(source, name, MULTIPLICATIVE, value); }
...
//    }
    ...
    public void putModification(String source, String name, String modification, float value) {
