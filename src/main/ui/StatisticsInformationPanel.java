...
public class StatisticsInformationPanel extends EscapablePanel {
    ...
    private boolean mShouldOpenGreaterStatisticsPanel = false;
//    private Lis
    public StatisticsInformationPanel(int x, int y, int width, int height, Color color, int visibleRows) {
