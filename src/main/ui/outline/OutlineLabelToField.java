...
public class OutlineLabelToField extends JPanel {
    ...
    public OutlineLabelToField() { }


    public OutlineLabelToField(int width, int height) { this("", width, height); }
    public OutlineLabelToField(Color color, int width, int height) { this("", color, width, height); }
    public OutlineLabelToField(String leftText, int width, int height) { this(leftText, null, width, height); }
    public OutlineLabelToField(String leftText, Color color,  int width, int height) {
        removeAll();
