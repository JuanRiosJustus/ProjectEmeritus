...
public class OutlineToggleButton extends JToggleButton {
    ...
    // Constructors
    public OutlineToggleButton() {
        this("");
    }

    public OutlineToggleButton(int outlineThickness) {
        this("", SwingConstants.CENTER, outlineThickness, null);
    }

    public OutlineToggleButton(String text) {
        this(text, SwingConstants.CENTER, 2, null);
    }

    public OutlineToggleButton(String text, int horizontalAlignment) {
        this(text, horizontalAlignment, 2, null);
    }

    public OutlineToggleButton(String text, int horizontalAlignment, int thickness) {
        this(text, horizontalAlignment, thickness, null);
    }

    public OutlineToggleButton(String text, int horizontalAlignment, int thickness, BufferedImage[] animation) {
        super(text);
