...
public class OutlineDropDownsToImageRow extends GameUI {
...
//    }
    ...
    private Map<String, OutlineComboBoxWithHelper> mDropDownRows = new LinkedHashMap<>();

    public OutlineComboBoxWithHelper getDropDownField(String key) {
        OutlineComboBoxWithHelper row = mDropDownRows.get(key);
        return row;
    }

    public OutlineComboBoxWithHelper addDropDownField(String key) {
        return addDropDownField(key, null);
    }
    public OutlineComboBoxWithHelper addDropDownField(String key, String helpText) {
        OutlineComboBoxWithHelper row = new OutlineComboBoxWithHelper(helpText, mColor, mDropDownWidths, mDropDownHeights);
