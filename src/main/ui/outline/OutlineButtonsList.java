...
public class OutlineButtonsList extends GameUI {
    ...
    public OutlineButtonsList(int width, int height, Color color) {
        this(width, height, color, DEFAULT_VISIBLE_ROWS);
    }

    public OutlineButtonsList(int width, int height, Color color, int visibleRows) {
        super(width, height);
