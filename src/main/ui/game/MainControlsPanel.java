...
//        setStyle(JavaFxUtils.TRANSPARENT_STYLING);
    ...
    public Pair<BeveledButton, BeveledCheckbox> getStandbyButton() {
        return getOrCreateRow("Standby");
    }
...
//        JSONObject currentTurnState = gameController.getCurrentUnitTurnStatus();
        JSONObject currentTurnState = gameModel.getSelectedUnitsTurnState();
