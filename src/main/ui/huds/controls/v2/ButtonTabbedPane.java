...
//        mCardLayoutContainer.setBackground(ColorPalette.getRandomColor());
    ...
    public void addPanel(String panelName, JComponent component, JButton backButton, boolean useBackButtonOnly) {

        JButton newButton = new JButton(panelName);
        mButtonToComponent.put(panelName, component);
        if (useBackButtonOnly) {
            newButton = backButton;
            mButtonToComponent.put(panelName, backButton);
        }
        SwingUiUtils.stylizeComponent(newButton, ColorPalette.WHITE);
