 ...
 */
public class AccordionV2 extends JPanel implements ActionListener
{
    /**
     ...
     */
    private final Map<String, BarInfo> bars = new LinkedHashMap<>();
    ...
    public void actionPerformed(ActionEvent e) {
        int currentBar = 0;
        for (Map.Entry<String, AccordionV2.BarInfo> entry : bars.entrySet()) {
    ...
    public static void main( String[] args )
    {
        ...
        AccordionV2 outlookBar = new AccordionV2();
