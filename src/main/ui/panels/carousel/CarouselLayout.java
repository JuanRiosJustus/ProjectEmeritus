        ...
        synchronized (parent.getTreeLock()) {
            ...
            for (int i = 0; i < ncomponents; i++) {
                ...
                if (i == 0) {
                    ...
                    comp.setBounds(hgap + insets.left, vgap + insets.top, parent.getPreferredSize().width - (hgap * 2 + insets.left + insets.right),
                            parent.getPreferredSize().height - (vgap * 2 + insets.top + insets.bottom));
                }
                if (comp.isVisible()) {
                    currentFound = true;
                }
