...
public class JSONTableViewerV1 extends BorderPane {
     ...
     */
    public JSONTableViewerV1(JSONObject json) {
    ...
    private void showNestedJSON(JSONObject nested, String title) {
        ...
        JSONTableViewerV1 viewer = new JSONTableViewerV1(nested);
    ...
    public static class TestApp extends Application {
        ...
        public void start(Stage primaryStage) {
            ...
            JSONTableViewerV1 viewer = new JSONTableViewerV1(json);
