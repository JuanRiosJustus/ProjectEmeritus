...
//        int columns = 10;
        ...
        GameControllerV1 gameControllerV1 = GameControllerV1.create(configs);
...
//        gameController.setSettings(GameStateV2.GAMEPLAY_MODE, GameStateV2.GAMEPLAY_MODE_REGULAR);
        ...
        for (int i = 0; i < unitsPerTeam; i++) {
            ...
            int randomRow =  random.nextInt(gameControllerV1.getRows());
            int randomColumn =  random.nextInt(gameControllerV1.getColumns());
            gameControllerV1.spawnUnit(unitEntity, "enemy", randomRow, randomColumn);
        }
        ...
        for (int i = 0; i < unitsPerTeam; i++) {
            ...
            int randomRow =  random.nextInt(gameControllerV1.getRows());
            int randomColumn =  random.nextInt(gameControllerV1.getColumns());
            gameControllerV1.spawnUnit(unitEntity, "user", randomRow, randomColumn);
        }
        ...
        int randomRow =  random.nextInt(gameControllerV1.getRows());
        int randomColumn =  random.nextInt(gameControllerV1.getColumns());
        boolean wasPlaced = gameControllerV1.spawnUnit(unitEntity, "user", randomRow, randomColumn);
        while (!wasPlaced) {
            randomRow =  random.nextInt(gameControllerV1.getRows());
            randomColumn =  random.nextInt(gameControllerV1.getColumns());
            wasPlaced = gameControllerV1.spawnUnit(unitEntity, "user", randomRow, randomColumn);
        }
...
//        controller.run();
        ...
        Engine.getInstance().getController().stage(new GameScene(gameControllerV1, screenWidth, screenHeight));
...
//        controller.run();
        ...
        Engine.getInstance().getController().stage(new GameScene(gameControllerV1, width, height - Engine.getInstance().getHeaderSize()));
