...
public class Summary extends Component {
    ...
    private String name;
    private final Map<String, ScalarNode> stats = new HashMap<>();
    ...
    private void initialize(Unit template) {
        ...
        stats.put(Constants.HEALTH, new ScalarNode(Constants.HEALTH, template.health));
        stats.put(Constants.ENERGY, new ScalarNode(Constants.ENERGY, template.energy));
    ...
    public ScalarNode getScalarNode(String name) { return stats.get(name); }
